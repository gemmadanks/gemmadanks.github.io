...
- [Decision matrix template (Excel version)][decision-matrix-template-excel]
- [Decision matrix template (Google sheet)][decision-matrix-template-google-sheet]

You can see my version below.

## My shortlist of research topics
The table below is the end result of my decision matrix (here is the [spreadsheet version][research-topic-decision-matrix-spreadsheet]). 
...
### Share your thoughts <!-- omit in toc -->
